	...
	<div class="col-md-9 fundobranco">
		...
		<form action="lib/ctrl/alteraNome.php" method="post" id="formnome">
			<div class="form-group">
				...
				<input class="form-control" type="text" id="novonome" name="novonome" value=""></input>
			</div>
			<div class="form-group">
				<label class="control-label" for="novosobrenome">Novo Sobrenome:</label>
				<input class="form-control" type="text" id="novosobrenome" name="novosobrenome" value=""></input>
			</div>
