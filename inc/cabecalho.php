		...
		<nav class="navbar navbar-inverse">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a href="index.php"><img class="navbar-brand" alt=""
						src="lib/img/logosemfundo2.png"
						style="width: 120px; height: 70px; margin-top: -10px; margin-bottom: -5px;"></img></a>
				</div>
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav navbar-right">
						<li id="menuRegistro"><a href="#" data-toggle="modal"
							data-target="#modal-register">Registre-se</a></li>
						<li id="menuLogin"><a href="#" data-toggle="modal"
							data-target='#login-modal' id="navLogin">Login</a></li>
						<li class="dropdown" id="menuBemvindo"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown" role="button"
							aria-haspopup="true" aria-expanded="false">Bem vindo! <?php echo get_username(); ?>
					...
					<div class="modal-body">
						...
						<form role="form" action="" method="post"
							...
							<div class="form-group has-feedback">
								<label class="sr-only control-label" for="login">Email</label> <input
							...
							<div class="form-group has-feedback">
								<label class="sr-only control-label" for="nome">Informe seu Nome</label>
								<input type="text" name="nome" class="form-control" id="nome"
									aria-describedby="inputSuccess2Status" placeholder="Nome..."> <span
									class="glyphicon form-control-feedback" id="nome1"></span> <span
							...
							<div class="form-group has-feedback">
								<label class="sr-only" for="telefone">Telefone</label> <input
									type="text" name="telefone" placeholder="Telefone"
									class="form-email form-control" id="idtelefone"></input>
							</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header" align="center">
						<img class="" id="img_logo" src="lib/img/logofundo.png">
						<button type="button" class="close" data-dismiss="modal"
							aria-label="Close">
					...
					<div id="div-forms">
						...
						<form id="formlogin" action="lib/ctrl/login.php" method="post">
							<div class="modal-body">
								...
								<div class="form-group">
									<input id="login_senha" class="form-control" type="password"
