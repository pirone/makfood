...
if (isset ( $_POST ['cadastrar'] )) {
	...
	echo $cadastro->rowCount () == 1 ? '<div class="alert alert-success"><i class="glyphicon glyphicon-ok"></i> Cadastrado com sucesso!</div>' : '<div class="alert alert-danger"><i class="glyphicon glyphicon-remove"></i> Um erro ocorreu, por favor, tente novamente.</div>';
} else {
