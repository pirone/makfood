...
<link href="lib/js/plugins/bxslider/jquery.bxslider.css"
	rel="stylesheet">
...
<div class="container">
	<div id="pizzabanner">
		<ul>
					...
					<li><img id="pizzabanner"
				src="lib/img/pizza_banner<?php echo $i; ?>.jpg" /></li>
					<?php } ?>
				</ul>
	</div>
			...
			<div id="massa">
				<ul class="list-group" id="listaTamanho">
					<li class="list-group-item disabled" data-placement="bottom"
						...
						title="Selecione o tamanho!"><strong>Selecione o tamanho da Pizza</strong></li>
					<li class="list-group-item" data-tam="g">Grande (5 Ingredientes) <span
						class="badge">R$ 10,00</span>
					</li>
					<li class="list-group-item" data-tam="m">Média (3 Ingredientes) <span
						class="badge">R$ 7,00</span>
					</li>
					<li class="list-group-item" data-tam="p">Pequena (2 Ingredientes) <span
						class="badge">R$ 4,00</span>
					</li>
				</ul>
			</div>
				...
				<div>
					...
					<div align="right" class="col-md-12 form-group" id="total">
						...
						<div class="col-md-4" id="divtotalpizza">
							<input class="form-control" name="total" id="totalpizza" value=""
								readonly="readonly" />
						</div>
					</div>
					<div class="col-md-12" align="right" id="fecharPedido">
							...
							<span class="glyphicon glyphicon-ok"></span> Fechar pedido
								...
								<?php } else {?>
									<div id="msgnaologado" class="alert alert-info" role="alert">
							<strong>É necessário estar logado para fechar o pedido!</strong>
						</div>
								<?php };?>
							</div>
				</div>
