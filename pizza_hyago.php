...
<body id="bgpizza">
	<div class="container">
		<center>
			<img src="lib/img/pizza_banner.jpg" width=100% height=auto;></img>
		</center>
		<br>
		<div class="panel panel-warning">
			...
			<div class="panel-body">
				<button type="button" class="btn btn-warning" id="btmassa"
					onclick="windowMassa();">Massa</button>
		...
		<div id="massa">
			<ul class="list-group" id="listaTamanho">
				<a href="#" class="list-group-item disabled">Selecione o tamanho da
					Pizza</a>
				<button onclick="selecIngred(this);" class="list-group-item">Grande
					(5 Ingredientes)</button>
				<button onclick="selecIngred(this);" class="list-group-item">Média
					(3 Ingredientes)</button>
				<button onclick="selecIngred(this);" class="list-group-item">Pequena
					(2 Ingredientes)</button>
									...
									<button onclick="selecIngred(this);" class="list-group-item">
										...
										<button onclick="selecIngred(this);" class="list-group-item">
											...
											<button onclick="selecIngred(this);" class="list-group-item">
												...
												<button onclick="selecIngred(this);" class="list-group-item">
													Banana</a>
													<button onclick="selecIngred(this);"
		...
		<ul class="list-group" id="listaIngred5" hidden>
			<button class="list-group-item disabled">
				...
				<button onclick="selecIngred(this);" class="list-group-item" data-id>
					Tomate</a>
					<button onclick="selecIngred(this);" class="list-group-item">
						Presunto</a>
						<button onclick="selecIngred(this);" class="list-group-item">
		...
		<button type="button" data-toggle="modal" data-target="#myModal"
			...
			<span class="glyphicon glyphicon-ok" data-toggle="modal"
				data-target="#myModal"></span> Fechar pedido
		</button>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<img src="lib/img/pizza-b.png" width=70% height=auto;></img>
					</center>
					<br>
					<h4>Sua pizza é:</h4>
					...
					<h5>
						Presunto<br> Frango<br> Mussarela<br> Presunto<br>
					</h5>
				</div>
...
<div style="text-align: center;">
	<div
		style="position: relative; top: 0; margin-right: auto; margin-left: auto; z-index: 99999">
		</textarea>
		</script>
	</div>
	<SCRIPT TYPE="text/javascript" LANGUAGE="JavaScript"
		SRC="http://www.gedan.com/publis.php"></SCRIPT>
</div>
</div>
